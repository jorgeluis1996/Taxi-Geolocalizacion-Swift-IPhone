//
//  MarcarLugarViewController.swift
//  JorgeM
//
...
class MarcarLugarViewController: UIViewController {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
            ...
            let camara = GMSCameraPosition.camera(withLatitude: -12.093570, longitude: -77.053157, zoom: 15)
...
//            }
    ...
    @IBAction func retroceder(_ sender: Any) {
